                                ...
                                <tr rowId={{ $item }}>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{ asset($details['image']) }}" alt="image" class="product-image">
                                        </div>
                                    ...
                                    <td class="quantity__item" style="text-align: center;">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <a href="{{ route('quantitycart', ['id' => $item, 'type' => 'plus']) }}" style="text-decoration: none;">
                                                    <span class="inc qtybtn" style="display: inline-block; padding: 5px; background-color: #333; color: #fff;">+</span>
                                                </a>
                                                <input type="text" value="{{ $details['quantity'] }}" readonly style="width: 30px; text-align: center;">
                                                <a href="{{ route('quantitycart', ['id' => $item, 'type' => 'minus']) }}" style="text-decoration: none;">
                                                    <span class="dec qtybtn" style="display: inline-block; padding: 5px; background-color: #333; color: #fff;">-</span>
                                                </a>
                                            </div>
                                        </div>
                                    </td>
